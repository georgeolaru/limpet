...
MENU_APP_DST="$HOME/Applications/Limpet.app"
LEGACY_MENU_APP_DST="$HOME/Applications/Limpet Menu.app"
...
[ -d "$LEGACY_MENU_APP_DST" ] && rm -rf "$LEGACY_MENU_APP_DST" && echo "  - removed $LEGACY_MENU_APP_DST" || true
